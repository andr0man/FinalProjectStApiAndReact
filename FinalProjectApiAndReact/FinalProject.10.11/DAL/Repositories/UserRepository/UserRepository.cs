...
namespace DAL.Repositories.UserRepository
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            var roleToRemove = user.UserRoles.FirstOrDefault(r => r.RoleId == role);
            ...
            if (roleToRemove == null)
            {
                ...
                {
                    Code = "RoleNotFound",
                    Description = $"Роль '{role}' не знайдена у користувача"
                });
            }
            ...
            return result.Succeeded
                ...
                : IdentityResult.Failed(new IdentityError { Description = "Не вдалося видалити роль" });
        }
